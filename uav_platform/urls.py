...
urlpatterns = [
    ...
    path("system/users/", system_user_page, name="page-system-user-list"),
    path("system/config/", system_config_page, name="page-system-config"),
    path("system/logs/", system_log_page, name="page-system-log-list"),
